...
> The demo GIF lands as part of the demo-GIF Phase 2 task — until then, the link above will 404. The screenshots a recruiter sees today are best generated by downloading the [latest release](https://github.com/Major-Lag98/Forge/releases) and running it yourself.
